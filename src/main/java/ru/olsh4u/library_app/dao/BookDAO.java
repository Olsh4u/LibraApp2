//package ru.olsh4u.library_app.dao;
//
...
//    }
//
//    // Join'им таблиуц Book и Person и получаем человека, которому принадлежит книга с указанным id
...
//    }
//
//    // Освобождает книгу (этот метода вызывается, когда человек возвращает книгу в библиотеку)
